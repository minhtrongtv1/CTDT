            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Html->link('Bỏ lọc', array('action' => 'pkt_device_index'), array('class' => 'btn btn-warning btn-xs')); ?>
                    </div>
                </div>
...
<script>
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post("<?php echo BASE_URL ?>/pkt/devices/pkt_index", data, function (response) {
