...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Thêm mới đơn vị'); ?> </a>
    </h4>
    ...
    ?>
    <?php echo $this->Form->input('code', ['label' => 'Mã đơn vị']); ?>
    <?php echo $this->Form->input('title', ['label' => 'Tên đơn vị']); ?>
    <?php echo $this->Form->input('lms_id', ['label' => 'Mã Lms']); ?>
