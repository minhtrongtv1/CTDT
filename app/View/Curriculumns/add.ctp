...
<div class="col-md-9 col-md-offset-1 well">
    ...
    <?php echo $this->Form->create('Curriculumn', array(
            'role'=>'form',
            ...
            'inputDefaults' => array(
                ...
                'class' => 'form-control',
						...
						<?php echo $this->Form->input('diploma', ['label' => 'Văn bằng tốt nghiệp']); ?>
						<?php echo $this->Form->input('Subject', ['label' => 'Học phần đào tạo']);?>
