            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Html->link('Bỏ lọc', array('action' => 'pkt_major_index'), array('class' => 'btn btn-warning btn-xs')); ?>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-hover has-checked-item">
                    <thead>
                        ...
                        <tr class="headings">
                            ...
                            <th class="column-title"><?php echo $this->Paginator->sort('code', 'Tên ngành'); ?></th>
                            <th class="column-title"><?php echo $this->Paginator->sort('name', 'Mã ngành'); ?></th>
...
<script>
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post("<?php echo BASE_URL ?>/pkt/majors/pkt_index", data, function (response) {
