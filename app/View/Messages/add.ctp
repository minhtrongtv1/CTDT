...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Add Message'); ?> </a>
    </h4>
    ...
    <div class="clearfix form-actions">
        <div class="pull-right">
            ...
            &nbsp; &nbsp; &nbsp;
            <?php echo $this->Html->link('<i class="ace-icon fa fa-undo bigger-110"></i>Quay lại hộp thư đến', array('action' => 'inbox'), array('class' => 'btn btn-warning', 'escape' => false)); ?>
