...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Department Supporter'); ?> </a>
    </h4>
    <div class="hr hr-18 dotted hr-double"></div>


    <?php
    echo $this->Form->create('DepartmentSupporter', array(
        'role' => 'form',
    ...
    <?php echo $this->Form->input('start_date', array('class' => false)); ?>
    <?php echo $this->Form->input('end_date', array('class' => false)); ?>
