    ...
    <div class="col-xs-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php echo __('Level'); ?></h3>
                <div class="box-tools pull-right">
                    <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $level['Level']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                </div>
            </div>

            <div class="box-body table-responsive">
                <table id="Levels" class="table table-bordered table-striped">
                    <tbody>
                        <tr>		<td><strong><?php echo __('Code'); ?></strong></td>
                            <td>
                                <?php echo h($level['Level']['code']); ?>
                                &nbsp;
                            </td>
        ...
        <div class="box box-primary">
            ...
            <?php if (!empty($level['Curriculumn'])): ?>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            foreach ($level['Curriculumn'] as $curriculumn):
                                ?>
                                <tr>
