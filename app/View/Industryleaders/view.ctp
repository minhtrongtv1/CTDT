        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                <table id="Industryleaders" class="table table-bordered table-striped">
                    <tbody>
                        <tr>		<td><strong><?php echo __('Tên giáo viên'); ?></strong></td>
                            <td>
                        ...
                        </tr><tr>		<td><strong><?php echo __('Chương trình đào tạo'); ?></strong></td>
                            <td>
                        ...
                        </tr><tr>		<td><strong><?php echo __('Vai trò'); ?></strong></td>
                            <td>
                        ...
                        </tr><tr>		<td><strong><?php echo __('Ngành đào tạo'); ?></strong></td>
                            <td>
