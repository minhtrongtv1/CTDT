...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Thay đổi thông tin chủ trì ngành'); ?> </a>
    </h4>
    <div class="hr hr-18 dotted hr-double"></div>


    <?php
    echo $this->Form->create('Industryleader', array(
        'role' => 'form',
    ...
    <?php echo $this->Form->input('role_id', ['label' => 'Vai trò']); ?>
