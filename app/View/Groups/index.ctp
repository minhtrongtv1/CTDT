            ...
            <div class="row">
                ...
                <div class="col-md-12">
                                                                        ...
                                                                        <?php echo $this->Form->input('name',array('placeholder'=>'name','class'=>'form-control','div' => 'form-group','label'=>array('class'=>'sr-only')));?>
                                                                                                ...
                                                                                                <?php echo $this->Form->input('image',array('placeholder'=>'image','class'=>'form-control','div' => 'form-group','label'=>array('class'=>'sr-only')));?>
                                                                                                <?php echo $this->Form->input('image_path',array('placeholder'=>'image_path','class'=>'form-control','div' => 'form-group','label'=>array('class'=>'sr-only')));?>
                                                                                                <?php echo $this->Form->input('decription',array('placeholder'=>'decription','class'=>'form-control','div' => 'form-group','label'=>array('class'=>'sr-only')));?>
