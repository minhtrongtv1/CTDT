...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Add Program Objective'); ?> </a>
    </h4>
    ...
    <?php echo $this->Form->input('level', ['label' => 'Mức độ']); ?>
    <?php echo $this->Form->input('typeobjective_id', ['label' => 'Loại chuẩn đầu ra']); ?>
    <?php echo $this->Form->input('curriculumn_id', ['label' => 'Chương trình đào tạo']); ?>
    <?php echo $this->Form->input('programoutcome_id', ['label' => 'Tên mục tiêu đào tạo']); ?>
