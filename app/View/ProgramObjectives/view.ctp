    ...
    <div class="col-xs-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php  echo __('Program Objective'); ?></h3>
...
<<<<<<< HEAD
                            <td>
                                <?php echo $this->Html->link($programObjective['Curriculumn']['name_vn'], array('controller' => 'curriculumns', 'action' => 'view', $programObjective['Curriculumn']['id']), array('class' => '')); ?>
                                &nbsp;
                            </td>
                            ...
                            <td>
                                <?php echo h($programObjective['ProgramObjective']['code']); ?>
                                &nbsp;
                            </td>
                        ...
                        </tr><tr>		<td><strong><?php echo __('Group Type'); ?></strong></td>
                            <td>
...
>>>>>>> 9601e65485cad2e2fac91834a9f306637e13bc29
