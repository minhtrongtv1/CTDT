        ...
        <div class="x_content"> 
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo $this->Form->input('typeobjective_id', array('placeholder' => 'Loại nhóm chuẩn đầu ra', 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>

                    <?php echo $this->Form->input('programoutcome_id', array('placeholder' => 'Mục tiêu chuẩn đầu ra', 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>

                    <div class="form-group">
                        <?php echo $this->Form->button('Lọc', array('type' => 'submit', 'class' => 'btn btn-primary btn-xs')); ?>
                        <?php echo $this->Html->link('Bỏ lọc', array('action' => 'pkt_objective_index'), array('class' => 'btn btn-warning btn-xs')); ?>
                    </div>
                </div>
...
<script>
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post("<?php echo BASE_URL ?>/pkt/programObjectives/index", data, function (response) {
