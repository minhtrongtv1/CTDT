        ...
        <div class="x_content"> 
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo $this->Form->input('evaluation_round_id', array('placeholder' => 'evaluation_round_id', 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>
                    ...
                    <?php echo $this->Form->input('pass', array('placeholder' => 'pass', 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>
                    <?php echo $this->Form->input('reason', array('placeholder' => 'reason', 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>
                ...
                <table class="table table-bordered table-hover has-checked-item">
                    <thead>
                        ...
                        <tr class="headings">
                            ...
                            <th class="column-title"><?php echo $this->Paginator->sort('evaluation_round_id'); ?></th>
                            ...
                            <th class="column-title"><?php echo $this->Paginator->sort('pass'); ?></th>


                            <th class="column-title"><?php echo $this->Paginator->sort('reason'); ?></th>
...
<script>
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post("http://localhost/tlc_portal//admin/evaluationResults/index", data, function (response) {
    ...
    $(document).on("click", "#delete-seleted", function () {
        ...
        if (confirm("Thao tác này không thể phục hồi, bạn chắc chắn muốn thực hiện ?")) {
            var selectedRecord = $(".has-checked-item input[name='selete-item']:checked").serializeArray();
            $.post('http://localhost/tlc_portal//admin/evaluationResults/delete', {selectedRecord: selectedRecord}, function (response) {
                if (response) {
