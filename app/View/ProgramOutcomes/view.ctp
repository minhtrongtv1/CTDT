...
</tr><tr>		<td><strong><?php echo __('Curriculumns'); ?></strong></td>
		<td>
			<?php echo $this->Html->link($programOutcome['Curriculumns']['id'], array('controller' => 'curriculumns', 'action' => 'view', $programOutcome['Curriculumns']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
