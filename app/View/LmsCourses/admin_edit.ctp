...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Lms Course'); ?> </a>
    </h4>
    <div class="hr hr-18 dotted hr-double"></div>


    <?php echo $this->Form->create('LmsCourse', array(
            'role'=>'form',
            ...
            'inputDefaults' => array(
                ...
                'class' => 'form-control',
						...
						<?php echo $this->Form->input('categoryname'); ?>
						<?php echo $this->Form->input('startdate'); ?>
						<?php echo $this->Form->input('visible'); ?>
						<?php echo $this->Form->input('scholastic'); ?>
						<?php echo $this->Form->input('timecreated'); ?>
						<?php echo $this->Form->input('timemodified'); ?>
