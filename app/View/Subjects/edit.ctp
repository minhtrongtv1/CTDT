...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Subject'); ?> </a>
    </h4>
    ...
    <?php echo $this->Form->input('theory_credit'); ?>
    <?php echo $this->Form->input('practice_credit'); ?>
    <?php echo $this->Form->input('theory_hour'); ?>
    <?php echo $this->Form->input('practice_hour'); ?>
    <?php echo $this->Form->input('self_learning_time'); ?>
    <?php echo $this->Form->input('note'); ?>
    <?php echo $this->Form->input('describe'); ?>
    <?php echo $this->Form->input('outline'); ?>
    <?php echo $this->Form->input('id'); ?>
    <?php echo $this->Form->input('Book'); ?>
    <?php echo $this->Form->input('Curriculumn'); ?>
