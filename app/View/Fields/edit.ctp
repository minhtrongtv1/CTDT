...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Field'); ?> </a>
    </h4>
    <div class="hr hr-18 dotted hr-double"></div>


    <?php echo $this->Form->create('Field', array(
            'role'=>'form',
            ...
            'inputDefaults' => array(
                ...
                'class' => 'form-control',
						...
						<?php echo $this->Form->input('chapter_count'); ?>
						<?php echo $this->Form->input('field_image_dir'); ?>
						<?php echo $this->Form->input('field_image_filename'); ?>
