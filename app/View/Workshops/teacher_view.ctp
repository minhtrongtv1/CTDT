                                ...
                                <td>
                                    ...
                                    <p><?php
                                        if ($workshop['Workshop']['status'] == WORKSHOP_DANG_DANG_KY && !in_array($workshop['Workshop']['id'], $enrolments)) {
                                            ...
                                            echo '<span class="text-success"><i class="fa fa-flag orange bigger-130"></i> Đã đăng ký</span>';
                                        }
                                        ?></p>
                                    &nbsp;
                                </td>
                ...
                <div class="box box-primary">
                    ...
                    if (!empty($workshop['Enrolment'])):
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <p>
                                <?php foreach ($workshop['Enrolment'] as $enrolment):
                                    ?>
                                    <?php echo $enrolment['Teacher']['email']; ?>;
                                <?php endforeach; ?>
                            </p>
