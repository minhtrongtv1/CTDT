                        ...
                        <tr>
                            ...
                            for ($j = 2*$i; $j <= 2*$i+1; $j++):
                                ...
                                <td class="profile-picture">
                                    ...
                                    ?>
                                    <img class="avatar editable img-responsive" style="max-height:80px; max-width: 225px" alt="<?php echo $thiSinhs[$j]['ThiSinh']['ho_va_ten'] ?>" src="<?php echo $photo ?>" style="display: block;"/>
