...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Dong Tu The Hien'); ?> </a>
    </h4>
    <div class="hr hr-18 dotted hr-double"></div>


    <?php echo $this->Form->create('DongTuTheHien', array(
            'role'=>'form',
            ...
            'inputDefaults' => array(
                ...
                'class' => 'form-control',
						...
						<?php echo $this->Form->input('english_name'); ?>
						<?php echo $this->Form->input('muc_do_nhan_thuc_id'); ?>
