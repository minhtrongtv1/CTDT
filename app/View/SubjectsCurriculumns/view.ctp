...
<div class="row">
    <div class="col-xs-12">
		...
		<td>
			<?php echo $this->Html->link($subjectsCurriculumn['Subject']['name'], array('controller' => 'subjects', 'action' => 'view', $subjectsCurriculumn['Subject']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
		...
		<td>
			<?php echo $this->Html->link($subjectsCurriculumn['Semester']['name'], array('controller' => 'semesters', 'action' => 'view', $subjectsCurriculumn['Semester']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Typesubject'); ?></strong></td>
		<td>
			<?php echo h($subjectsCurriculumn['SubjectsCurriculumn']['typesubject']); ?>
			&nbsp;
		</td>
