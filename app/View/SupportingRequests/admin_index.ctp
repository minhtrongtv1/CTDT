        ...
        <div class="x_content"> 
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo $this->Form->input('status', array('empty' => '-- Chọn tình trạng --', 'options' => array(YEU_CAU_HO_TRO_CHO_XU_LY => 'Chờ xử lý', YEU_CAU_HO_TRO_DA_XU_LY => 'Đã xử lý'), 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>
                    ...
                    <?php echo $this->Form->input('approved', array('empty' => '-- Tình trạng duyệt --', 'options' => array('K' => 'Chưa kiểm tra', 'Y' => 'Đã xong'), 'class' => 'form-control', 'div' => 'form-group', 'label' => array('class' => 'sr-only'))); ?>
                ...
                <table class="table table-bordered table-hover has-checked-item">
                    <thead>
                        ...
                        <tr class="headings">
                            ...
                            <th class="column-title"><?php echo $this->Paginator->sort('approved', 'Admin kiểm tra'); ?></th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($supportingRequests as $supportingRequest): ?>
                            <tr id="row-<?php echo $supportingRequest['SupportingRequest']['id'] ?>">
                                ...
                                <td class=""><?php echo h($supportingRequest['SupportingRequest']['approved']); ?>&nbsp;</td>
                                <td class="">
