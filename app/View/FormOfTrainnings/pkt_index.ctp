...
?><div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content"> 
            <div class="row">
                <?php echo $this->Form->create('FormOfTrainning', array('url' => array('action' => 'pkt_index'), 'id' => 'filter-form', 'class' => 'form-inline', 'role' => 'form', 'novalidate')); ?>
                <div class="col-md-12">
...
<script>
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post("<?php echo BASE_URL ?>/pkt/formoftrainnings/pkt_index", data, function (response) {
