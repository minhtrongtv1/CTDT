    ...
    <div class="col-xs-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php  echo __('Form Of Trainning'); ?></h3>
                <div class="box-tools pull-right">
                    <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $formOfTrainning['FormOfTrainning']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                </div>
            </div>
		...
		<td>
			<?php echo h($formOfTrainning['FormOfTrainning']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($formOfTrainning['FormOfTrainning']['modified']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Id'); ?></strong></td>
		<td>
			<?php echo h($formOfTrainning['FormOfTrainning']['id']); ?>
			&nbsp;
		</td>
</tr>                    </tbody>
    ...
    <?php if (!empty($formOfTrainning['Curriculumn'])): ?>
		...
		<th class="text-center"><?php echo __('Id'); ?></th>
                        ...
                        <tbody>
                            	<?php
										$i = 0;
										foreach ($formOfTrainning['Curriculumn'] as $curriculumn): ?>
		<tr>
