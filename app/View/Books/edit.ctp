...
<div class="col-md-9 col-md-offset-1 well">
    <h4 class="pink">
        ...
        <a href="#" class="blue"> <?php echo __('Edit Book'); ?> </a>
    </h4>
    ...
    <?php echo $this->Form->create('Book', array(
            ...
            'inputDefaults' => array(
                ...
                'class' => 'form-control',
						...
						<?php echo $this->Form->input('author_name'); ?>
						<?php echo $this->Form->input('publisher'); ?>
						<?php echo $this->Form->input('publishing_year'); ?>
						<?php echo $this->Form->input('link_libary'); ?>
