                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li>
                                    <?php
                                    echo $this->Html->link(
                                            '<i class="fa fa-check"></i> ' . __d('gallery', 'Album đã công khai'), '?status=published', array('escape' => false)
                                    )
                                    ?>
                                </li>
                                <li>
                                    <?php
                                    echo $this->Html->link(
                                            '<i class="fa fa-pagelines"></i> ' . __d('gallery', 'Album nháp'), '?status=draft', array('escape' => false)
                                    )
                                    ?>
                                </li>
                                <li>
                                    <?php
                                    echo $this->Html->link(
                                            '<i class="fa fa-arrow"></i>' . __d('gallery', 'Thoát giao diện album'), '/', array('escape' => false)
                                    )
                                    ?>
                                </li>
                            </ul>
