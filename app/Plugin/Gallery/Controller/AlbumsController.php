...
class AlbumsController extends GalleryAppController {
    ...
    public function update() {
        if ($this->request->is('post')) {
            if ($this->Album->save($this->request->data)) {
                echo 'Cài đặt album đã lưu thành công';
            }
        }
    ...
    public function delete($id) {
        ...
        if ($this->Album->delete($id)) {
            ...
            $this->Flash->success(__d('gallery', 'Album deleted.'));

            return $this->redirect(array('controller' => 'gallery', 'action' => 'index', 'plugin' => 'gallery'));
