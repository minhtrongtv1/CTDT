var Album = {
    ...
    configureEditable: function () {
        ...
        $('.caption .text').each(function () {
            $(this).editable({
                ...
                emptytext: __('Không có ghi chú ảnh'),
                title: __('Ghi chú ảnh'),
                success: function () {
                    toastr.success(__('Đã đổi ghi chú ảnh.'));
                }
            });
        });
    },
    ...
    saveOrder: function () {
        ...
        $.post(Album.config.sortUrl, {
            ...
            toastr.success(__('Đã lưu thứ tự ảnh!'));
        });
    },
    ...
    removePicture: function (e) {
        ...
        swal({
            title: __("Bạn chắc chắn thực hiện?"),
            text: __("Bạn sẽ không thể khôi phục ảnh sau khi xóa!"),
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: __("Vâng hãy xóa!"),
            ...
            $.ajax({
                ...
                swal(__("Đã xóa!"), __("Ảnh đã được xóa."), "success");
                $box.hide(500);
            });
        });
    },
