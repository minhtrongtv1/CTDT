...
CakePlugin::load('TinyMCE', array('bootstrap' => true));
...
//Recaptcha v2 Config
Configure::write('Recaptcha.SiteKey','6LcUOaEUAAAAAC43Jv2Krq8WwSJXbvtTBdCrZA_A');
Configure::write('Recaptcha.SecretKey','6LcUOaEUAAAAANKUGPFzJSM03du8aU9wGfl2aV4U');


require_once 'messages.php';
require 'contanst.php';
